...
|---------------|----------|-----------|---------------|-------------|
| `pingan_style` | Brand | Portfolio reviews, annuity reporting, investment commentary | Brick Red `#C0392B` | Warm-finance, conclusion-first, structured review |
...
|----------|-------------|
| `pingan_style` | Ping An-style portfolio review template, warm-finance palette, abstract cover, ribbon takeaway bars |
